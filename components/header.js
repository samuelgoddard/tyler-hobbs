      ...
      <LazyMotion features={domAnimation}>
        <header className="">
          <div className="absolute top-4 lg:top-8 left-4 lg:left-8 z-[100] leading-none">
            <div className="block">
              <Link href="/" aria-label="Navigate to the home page" className="a11y-focus w-[120px] block translate-y-[2px] lg:translate-y-0">
                    ...
                    <div className="w-1/2">
                      <button className="ml-auto w-10 block" onClick={()=> setTheme( resolvedTheme === 'dark' ? 'light' : 'dark' )}>
                        <svg className="w-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 207 248">
                          <path fill="currentColor" fillRule="evenodd" d="m103.3 123.8 103.3 61.9V61.9L103.3 0v123.8zm0 123.7V123.8L0 61.9v123.8l103.3 61.8z" clipRule="evenodd"/>
                        </svg>
                      </button>
                    </div>
                  </div>
