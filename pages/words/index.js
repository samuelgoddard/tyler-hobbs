    ...
    <Layout>
      ...
      <LazyMotion features={domAnimation}>
        ...
        >
          ...
          {/* Fixed Header Reveal */}
          <div className={`p-4 lg:p-8 fixed top-0 left-0 right-0 w-full z-[100] transition-transform ease-[cubic-bezier(0.71,0,0.17,1)] duration-[350ms] ${headerShown ? 'translate-y-0' : '-translate-y-full pointer-events-none' } bg-white dark:bg-black`}>
